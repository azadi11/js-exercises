...
var destinationNamesWithin500Kms = travelDestinations.filter(function(
  distanceKms
) {
  return distanceKms < 500;
}); // Complete here

var destinationNameReachableByFerry = destinationName.map(function(
  transportations
) {
  return transportations === ferry;
});

// Complete here

var destinationNamesMoreThan300KmsAwayByTrain = travelDestinations.map(function(
  travelDestinations
) {
  return travelDestinations > 300;
  if (transportations === train);
